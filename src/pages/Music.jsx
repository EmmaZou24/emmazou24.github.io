  ...
  return (
    <div className="page music-page">
      <div className="page-content">
        ...
        <p>Some of my favorite pieces I've played are Clarke Viola Sonata, Liszt Un Sospiro, Ravel La Valse, and Debussy String Quartet. You can find some of my recordings here! My current listening obsessions include Sibelius Symphony No. 1, Janáček String Quartet No. 2, and Stravinsky Petrushka; as for non-classical music, I've been loving Serotinalia by Cricket Blue, Eurus by The Oh Hellos, and anything by The Crane Wives.</p>
